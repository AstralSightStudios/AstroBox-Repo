...
需要说明的是，由于 AstroBox 插件商城在架构设计上对自由与无监管的追求，我们仅能从索引层面移除该插件，无法直接干预其作者自有的产物仓库与源码仓库（[https://github.com/Leakrooms/PowerfulPlugins](https://github.com/Leakrooms/PowerfulPlugins)）。因此，我们仍无法限制用户之间的私下传播及后续的进一步开发，对此深表遗憾。
...
1. 轻腕社区侧此前就 OrbitM 发布的相关声明（[https://qingwear.top/post/sYrJVq](https://qingwear.top/post/sYrJVq)） 将予以保留、不作删除，并在公开道歉公告中再次明确承认此前对开源协议使用不当的事实。
...
对方声明：[https://qingwear.top/post/UexGXV](https://qingwear.top/post/UexGXV)

轻腕社区和解致歉声明

为终结双方争议、达成友好和解，轻腕社区特此公开声明如下：

1. 我方将永久保留 OrbitM 相关公示文章（[https://qingwear.top/post/sYrJVq](https://qingwear.top/post/sYrJVq)） 不予删除，并承认我方过往在开源协议使用与引用方面存在不当、不规范的问题，对此郑重致歉。
